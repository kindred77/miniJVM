...
public class IntelligentCreatureOptionsDialog extends MirControlWithStaticImage {

  public IntelligentCreatureOptionsDialog(MirControl parent, long renderer_id,
