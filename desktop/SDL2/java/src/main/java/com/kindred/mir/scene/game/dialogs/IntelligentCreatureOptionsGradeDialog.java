...
public class IntelligentCreatureOptionsGradeDialog extends MirControlWithStaticImage {

  public IntelligentCreatureOptionsGradeDialog(MirControl parent, long renderer_id,
